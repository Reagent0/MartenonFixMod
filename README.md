...
#### Installing UE4SS  
Step 1: Download UE4SS ([UE4SS_v3.0.1-599-g1a6cdbc.zip](https://github.com/UE4SS-RE/RE-UE4SS/releases/download/experimental-latest/UE4SS_v3.0.1-599-g1a6cdbc.zip)). Keep in mind the mod was only tested with this specific version of UE4SS (the current experimental-latest at the time of this writing).  
